...
* 	\date    September 2014
* 	\version 0.1
* 	\brief   Example showing how to project and triangulate point with an iterative method for STEREO cameras
*
...
int main(int argc, char **argv) {
	...
	for (int i=0; i<p_init.size(); i++) {
		...
		Mat coord = stereo.triangulateStereoIterative(p_inter_L[i], p_inter_R[i]);
